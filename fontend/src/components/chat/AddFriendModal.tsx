...
import SentFriendRequestForm from "../addFriendModal/SentFriendRequestForm"
...
const AddFriendModal = () => {
    ...
    const {
        ...
        handleSubmit, // xử lí khi submit form
        watch, // theo dõi giá trị đang gõ
        reset, // reset form
        formState: {errors}
    } = useForm<IFormValues>({
